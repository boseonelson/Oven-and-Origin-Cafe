...
const sampleProducts = [
    { name: "Signature Latte", category: "Hot Coffee", price: 140, status: "Available" },
    { name: "Cappuccino", category: "Hot Coffee", price: 127, status: "Available" },
    { name: "Americano", category: "Hot Coffee", price: 137, status: "Available" },
    { name: "Affogato", category: "Hot Coffee", price: 135, status: "Available" },
    { name: "Iced Mocha", category: "Iced Coffee", price: 120, status: "Available" },
    { name: "Iced Coffee", category: "Iced Coffee", price: 122, status: "Available" },
    { name: "Irish Ice Coffee", category: "Iced Coffee", price: 142, status: "Available" },
    { name: "Vietnamese Ice Coffee", category: "Iced Coffee", price: 137, status: "Available" },
    { name: "Cookies & Cream", category: "Milk tea", price: 110, status: "Available" },
    { name: "Dark Chocolate", category: "Milk tea", price: 105, status: "Available" },
    { name: "Matcha", category: "Milk tea", price: 125, status: "Available" },
    { name: "Taro", category: "Milk tea", price: 119, status: "Available" },
    { name: "Butter Croissant", category: "Pastries", price: 145, status: "Available" },
    { name: "Dark Chocolate", category: "Pastries", price: 132, status: "Available" },
    { name: "Artisan Breads", category: "Pastries", price: 126, status: "Available" },
    { name: "Chocolate Cookies", category: "Pastries", price: 136, status: "Available" },
    { name: "Creamy Carbonara", category: "Pasta", price: 160, status: "Available" },
    { name: "Pesto Linguine", category: "Pasta", price: 150, status: "Available" },
    { name: "Seafood Pasta", category: "Pasta", price: 140, status: "Available" },
...
function renderAdminOrders() {
    ...
    tableBody.innerHTML = purchaseHistory.map((order, index) => `
        <tr>
            ...
            <td><span class="status-pill">New Order</span></td>
        </tr>
    `).join("");
}
